    ...
    <div id="wrapper">
        <div id="sidebar-wrapper" style="background: rgb(19,46,77);">
            <ul class="sidebar-nav">
                ...
                <li> </li>
                <li class="sidebar-brand" style="margin-top: 100px;"> <a href="../../../ModuloObra/obra-index.php" style="font-weight: bold;color: rgb(255,255,255);font-size: 22px;">Ir a Nomina</a><a href="../../../index.php?action=iniModNom" style="font-weight: bold;color: rgb(255,255,255);font-size: 22px;margin-top: -25px;">Ir a Obra</a></li>
            </ul>
        </div>
        <div class="page-content-wrapper">
            ...
            <div>
                <div class="jumbotron" style="background: rgba(233,236,239,0);padding-top: 120px;padding-bottom: 120px;">
                    <main>
                        <form style="display: flex;" action = "../../Modulo/php/InterfazControladorMateriales.php" method = "POST">
                            <div >
                                    ...
                                    <div class="container">
                                        <div class="intro">
                                            ...
                                            <div style="display: flex;">
                                                ...
                                                <a id="btnAgregar" href="../AgregarMaterial/index.php" style="font-weight: bold;background: #17164D;margin: 10px;width: inherit;color: white;padding: 7px;">Agregar</a>
                                            </div>
                                        </div>
                                    </section>
                                </div>
