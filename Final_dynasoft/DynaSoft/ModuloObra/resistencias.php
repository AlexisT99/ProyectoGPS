...
<head>
    ...
    <title>Informe de resistencias</title>
    ...
    <div id="wrapper">
        <div id="sidebar-wrapper" style="background: rgb(19,46,77);">
            <ul class="sidebar-nav">
                ...
                <li> <a href="resistencias.php" style="color: rgb(255,255,255);font-size: 19px;">Informe de resistencias</a><a
                        href="resistencias_1.php"
                        ...
                        previos</a><a href="resistencias_3.php"
                        style="color: rgb(255,255,255);font-size: 16px;margin: 0px;padding: 5px;padding-top: 0px;padding-right: 0px;padding-bottom: 0px;padding-left: 15px;">Datos
                        de la obra</a><a href="resistencias_4.php"
                        style="color: rgb(255,255,255);font-size: 16px;margin: 0px;padding: 5px;padding-top: 0px;padding-right: 0px;padding-bottom: 0px;padding-left: 15px;">Datos
                        del ensaye</a> !--> </li>
        ...
        <div class="page-content-wrapper">
            ...
            <div>
                ...
                <form action="manejo_informe.php" method="post" >
                    ...
                    <a href="resistencias_1.php"class="btn btn-primary" role="button"
                        ...
                        <table id="my_table" class="table" >
                            <thead>
                                <tr>
                                    <th>IdInforme</th>
                                    <th>IdObra</th>
                                    <th class="text-nowrap">Fecha informe</th>
                                    <th>Laboratorista</th>
                                    <th></th>
                                </tr>
                            </thead>
                            ...
                            <?php
                                ...
                                $conexion = conectar();
                                $sql = "select ID_INFORME_RESIS, ID_OBRA, FECHA_INFORME, LABORATORISTA from informe_resistencias where ID_OBRA ='$t2'";
                            ...
                            ?>
                                    <tr>
                                        <td><?php echo $mostrar['ID_INFORME_RESIS']; ?></td>
                                        <td><?php echo $mostrar['ID_OBRA']; ?></td>
                                        <td><?php echo $mostrar['FECHA_INFORME']; ?></td>
                                        <td><?php echo $mostrar['LABORATORISTA']; ?></td>
                                        <td>
                                            <input type="submit"  value="Ver informe" name="verinforme" onclick="myFunction()" class="btn btn-primary text-nowrap" style="background: #124177;font-weight: bold;width: 115px;border-color: rgb(143,0,0);">
                        ...
                        <script>
                            function myFunction(){
                                ...
                                rows[i].onclick = function() {
                                        ...
                                        var $s5 = this.getElementsByTagName('td')[4].innerHTML;
                                    
                                        console.log($s1);
                                        //alert((this.rowIndex + 1)+result); 
                                        //header('Location:manejo_informe.php?s1='.$s1);  
                                        location.href ="resistencias_1.php?s1="+$s1;
                                    }
                                }
                            }//funcion
                            function myFunction2(){
                                ...
                                rows[i].onclick = function() {
                                        ...
                                        //alert((this.rowIndex + 1)+result); 
                                        //header('Location:manejo_informe.php?s1='.$s1);  
                                        location.href ="manejo_informe.php?s1="+$s1;
                                    }
                                }
                            }//funcion
                        </script>
