    ...
    <div id="wrapper">
        <div id="sidebar-wrapper" style="background: rgb(19,46,77);">
            <ul class="sidebar-nav">
                ...
                <li> </li>
                <li class="sidebar-brand" style="margin-top: 100px;"> <a href="../ModuloInventario/Vista/InterfazInventario_Material/index.php"
                        style="font-weight: bold;color: rgb(255,255,255);font-size: 22px;">Ir a Inventario</a><a
                        href="../index.php?action=iniModNom" style="font-weight: bold;color: rgb(255,255,255);font-size: 22px;margin-top: -25px;">Ir
                        a Nomina</a></li>
            </ul>
        </div>
        <div class="page-content-wrapper">
            ...
            <div>
                ...
                <div style="text-align:center; display: flex; flex-wrap: wrap; justify-content:center; align-items:center; margin:30px;">
                
                <div style="font-weight: bold;background:white; border: #124177 5px solid; color: rgb(255, 255, 255);margin: 20px;width: 300px;">
                <img src="imagenes/cotizacion.png" width="auto" height="auto" style="margin: 10px;";>
                <br>
                <a href="Presupuesto.php"><input type="button" value="PRESUPUESTO" class="btn btn-primary" role="button" 
                style="font-weight: bold;background: #124177;color: rgb(255, 255, 255);margin: 20px;width: 150px;"></a>
                </div>

                <div style="font-weight: bold;background:white; border: #124177 5px solid;color: rgb(255, 255, 255);margin: 20px;width: 300px;">
                <img src="imagenes/obra.png" width="auto" height="auto" style="margin: 10px;";>
                <br>
                <a href="Obra.php"><input type="button" value="OBRAS" class="btn btn-primary" role="button" 
                style="font-weight: bold;background: #124177;color: rgb(255, 255, 255);margin: 20px;width: 150px;"> </a>
                </div>

                <div style="font-weight: bold;background:white; border: #124177 5px solid; color: rgb(255, 255, 255);margin: 20px;width: 300px;">
                <img src="imagenes/laboratorio.png" width="auto" height="auto" style="margin: 10px;";>
                <br>
                <a href="index-laboratorio.php"><input type="button" value="LABORATORIO" class="btn btn-primary" role="button" 
                style="font-weight: bold;background: #124177;color: rgb(255, 255, 255);margin: 20px;width: 150px;"> </a>
                </div>

                <div style="font-weight: bold;background:white; border: #124177 5px solid;color: rgb(255, 255, 255);margin: 20px;width: 300px;">
                <img src="imagenes/ingresos.png" width="auto" height="auto" style="margin: 10px;";>
                <br>
                <a href="Ingresos.php"><input type="button" value="INGRESOS" class="btn btn-primary" role="button" 
                style="font-weight: bold;background: #124177;color: rgb(255, 255, 255);margin: 20px;width: 150px;"> </a>
                </div>
