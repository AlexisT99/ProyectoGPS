            ...
            <div>
                ...
                <form action= "agregar-informe-concreto.php" method="POST" class="formulario"> 
                    ...
                    <p style="padding-bottom: 0px;"><label 
                            ...
                            <p><textarea
                            style="width: 550px;" name="Observa" rows="10" cols="50" value='<?php echo $t7; ?>'></textarea></p>
                    
                    <p>
                    <input type="submit" Value="Guardar" name="guardar" class="btn btn-primary" 
                            style="font-weight: bold;background: rgb(10,126,29);margin: 13px;width: 91px;">
                       
                        <a href="muestreo_Concreto_Viajes_4.php"><input type="button" Value="Viajes" class="btn btn-primary" role="button"
