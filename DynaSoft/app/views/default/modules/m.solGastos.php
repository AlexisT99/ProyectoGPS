                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6" id="message-1">
                                ...
                                <div class="form-group mb-3"><label class="form-label" for="from-name">Estado</label>
                                    <div class="input-group"><span class="input-group-text"><i class="fa fa-circle-o-notch"></i></span><input type="radio" style="width: 26px;height: 26px;margin-top: 6px;margin-right: 0px;margin-bottom: 6px;margin-left: 22px;" name="RadioEstado" id="RadioAceptar" value="A"><label class="form-label input-group-text" style="padding-top: 0px;padding-bottom: 0px;margin-bottom: 0px;margin-left: 0px;background: rgb(255,255,255);border-color: rgb(255,255,255);" for="RadioAceptar">Aceptada</label><input type="radio" value="R" style="width: 26px;height: 26px;margin-top: 6px;margin-bottom: 6px;margin-left: 10px;" name="RadioEstado" id="RadioRechazada"><label class="form-label input-group-text" style="padding-top: 0px;padding-bottom: 0px;margin-bottom: 0px;margin-left: 0px;background: rgb(255,255,255);border-color: rgb(255,255,255);" for="RadioRechazada">Rechazada</label></div>
                                </div>
                                <div class="form-group mb-3">
                                    <div class="row">
