...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-06-2021 a las 19:27:48
...
CREATE TABLE `catalogo_presupuesto` (
  ...
  `QUIEN_CLIENTE` varchar(100) DEFAULT NULL,
  `QUIEN_REALIZA` varchar(100) DEFAULT NULL
...
INSERT INTO `catalogo_presupuesto` (`ID_PRESUPUESTO`, `NUMERO`, `NORMA`, `CONCEPTO_SERVICIO`, `UNIDAD`, `CANTIDAD`, `PU`, `IMPORTE_LETRA`, `IMPORTE_NUMERO`, `QUIEN_CLIENTE`, `QUIEN_REALIZA`) VALUES
('1', 1, 'NCTRCAR123', 'Terreno Natural', 'Análisis', 3, '1000', '3000', 0, 'Pedro Sanchez', 'Luis Daniel Mendez Castellanos'),
('2', 1, 'MMMP101', 'Terracerias', 'Análisis', 3, '500', '1500', 0, 'Pedro Sanchez', 'Luis Daniel Mendez Castellanos'),
('3', 1, 'MMMP101', 'Terracerias', 'Análisis', 4, '500', '2000', 0, 'Pedro Sanchez', 'Luis Daniel Mendez Castellanos');
...
INSERT INTO `ingresos` (`IDINGRESO`, `ID_OBRA`, `IDTRABAJADOR`, `MONTO_INGRESO`, `FECHAINGRESO`, `DESCRIPCIONINGRESO`) VALUES
(1, 'OB18', 1, 3250, '2021-06-01', 'Pago Inicial');
...
INSERT INTO `registro_obras` (`ID_OBRA`, `IDTRABAJADOR`, `DESCRIPCION`, `CONTRATISTA_NOMBRE`, `TEL_CONTRATISTA`, `LUGAR_DESARROLLO`, `FECHA_INICIO_OBRA`, `FECHA_FINAL_OBRA`, `STATUS_OBRA`, `COSTO`, `NOMBRE`) VALUES
('OB18', 1, 'Reforzamiento de Puente', 'Pedro Sanchez', '3111203234', 'Melaque', '2021-06-15', '2021-06-18', 'Inicio', 6500, 'Puente Melaque');
...
ALTER TABLE `presupuesto_obras`
  ADD KEY `FK_CATALOGO_REFERENCE_PRESUPUE` (`ID_PRESUPUESTO`),
  ADD KEY `FK_PRESUPUE_REFERENCE_REGISTRO` (`ID_OBRA`);
...
--
-- Filtros para la tabla `presupuesto_obras`
--
ALTER TABLE `presupuesto_obras`
  ADD CONSTRAINT `FK_CATALOGO_REFERENCE_PRESUPUE` FOREIGN KEY (`ID_PRESUPUESTO`) REFERENCES `catalogo_presupuesto` (`ID_PRESUPUESTO`),
  ADD CONSTRAINT `FK_PRESUPUE_REFERENCE_REGISTRO` FOREIGN KEY (`ID_OBRA`) REFERENCES `registro_obras` (`ID_OBRA`);
